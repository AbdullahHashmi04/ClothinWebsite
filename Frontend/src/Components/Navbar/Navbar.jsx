  ...
  return (
    <li
      ...
      style={{
        ...
        fontFamily: "'DM Sans', sans-serif", fontWeight: "440", letterSpacing: "0.01em",
        color: isDanger ? (hovered ? "#c0392b" : "#e05c4b") : (hovered ? "#0f0c08" : "#4a3f30"),
        background: hovered ? (isDanger ? "rgba(220,60,40,0.06)" : "rgba(200,168,75,0.08)") : "transparent",
        borderRadius: "8px", margin: "0 6px", transition: "all 0.15s ease",
        outline: "none", userSelect: "none",
        animation: `itemIn 0.22s ease ${index * 40}ms both`,
      }}
    >
      <span style={{ color: isDanger ? (hovered ? "#c0392b" : "#e05c4b") : (hovered ? "#c8a84b" : "#9a8060"), display: "flex", transition: "color 0.15s ease" }}>
        {icon}
      </span>
      {label}
    </li>
...
function UserDropdown() {
  ...
  return (
    <>
      ...
      <div ref={containerRef} style={{ position: "relative", display: "inline-block", width: "200px" }}>
        <button
          ref={triggerRef}
