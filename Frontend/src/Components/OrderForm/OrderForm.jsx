...
const OrderForm = () => {
  ...
  const inputClassName = "w-full pl-12 pr-4 py-3.5 bg-slate-50 border border-slate-200 rounded-xl focus:bg-white focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 outline-none transition-all font-medium text-slate-800 placeholder-slate-400";
  const inputClassNameNoIcon = "w-full px-4 py-3.5 bg-slate-50 border border-slate-200 rounded-xl focus:bg-white focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 outline-none transition-all font-medium text-slate-800 placeholder-slate-400";
              ...
              >
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    {errors.CardNumber && <p className="text-red-500 text-xs font-semibold mt-2">{errors.CardNumber.message}</p>}
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-6">
                    <div>
                      ...
                      <input
                        ...
                        placeholder="MM/YY"
                      />
                      {errors.expiry && <p className="text-red-500 text-xs font-semibold mt-2">{errors.expiry.message}</p>}
                    </div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        placeholder="123"
                      />
                      {errors.cvv && <p className="text-red-500 text-xs font-semibold mt-2">{errors.cvv.message}</p>}
                    </div>
                  </div>
                </div>
              </motion.div>
                  ...
                  {cart.map((item, index) => (
                    <div key={item.id} className="flex gap-4 items-center">
                      ...
                      <div className="flex-1 min-w-0 flex flex-col justify-center">
                        ...
                        <input type="hidden" {...register(`cart.${index}.name`)} value={item.name} />
                        <input type="hidden" {...register(`cart.${index}.price`)} value={item.price} />

                        <h4 className="font-semibold text-sm truncate text-slate-100">{item.name}</h4>
                        <p className="text-slate-400 text-sm mt-0.5">${item.price}</p>
                      </div>
                    </div>
                  ))}
                </div>
                ...
                <div className="border-t border-white/10 pt-5 space-y-4">
                  ...
                  <div className="flex justify-between items-center pt-4 mt-2 border-t border-white/10">
                    ...
                    <div className="flex items-center">
                      <span className="text-2xl font-extrabold text-white mr-1">$</span>
